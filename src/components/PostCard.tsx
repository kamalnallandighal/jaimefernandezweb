  ...
  if (size === 'large') {
    return (
      ...
      >
        <div style={{
          display: 'grid',
          gridTemplateColumns: isDesktop ? '58% 42%' : '1fr',
          minHeight: isDesktop ? '540px' : 'auto',
        }}>
          {/* Image side */}
          <div style={{ position: 'relative', overflow: 'hidden', minHeight: isDesktop ? '540px' : '300px' }}>
            {post.cover_image_url ? (
              ...
              <div style={{ position: 'absolute', inset: 0, backgroundColor: '#eceae5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <span style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '4rem', color: 'rgba(194,155,64,0.35)', fontStyle: 'italic' }}>JF</span>
              </div>
            )}
          </div>
          ...
          <div style={{
            ...
            padding: isDesktop ? '56px 64px' : '36px 32px',
            display: 'flex',
            flexDirection: 'column',
            justifyContent: 'center',
            gap: '20px',
            borderTop: isDesktop ? 'none' : '3px solid #C29B40',
            borderLeft: isDesktop ? '3px solid #C29B40' : 'none',
          }}>
            {post.category && (
              <span style={{
                fontFamily: "'Source Sans 3', sans-serif",
            ...
            <h2
              ...
              style={{
                fontFamily: "'Cormorant Garamond', Georgia, serif",
                fontSize: isDesktop ? 'clamp(2rem, 3vw, 3rem)' : '2rem',
                fontWeight: 300,
                fontStyle: 'italic',
                lineHeight: 1.15,
                color: '#002349',
